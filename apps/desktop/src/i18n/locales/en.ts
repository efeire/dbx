...
export default {
  ...
  grid: {
    ...
    agentExecuteTime: "Agent execute: {ms} ms",
    ...
    clientRequestWait: "Client result wait: {ms} ms",
    clientRequestWaitHint: "Desktop time from query request dispatch until the full result payload arrives. Includes fetching and transport; excludes SQL preparation and grid rendering. Summed across loaded pages.",
